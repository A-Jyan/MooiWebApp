...
const Checkout = () => {
  ...
  return (
    <div className="checkout__product-container">
      <h1 className="checkout__main-title" style={{ fontSize: 24, textAlign: 'center' }}>Ingresá tus datos</h1>
      <div className="checkout__form-container">
        <form style={{ justifyContent: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <TextInput
            label="Nombre:"
            name="firstName"
            value={firstName}
